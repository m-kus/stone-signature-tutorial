...
dryrun:
	cairo1-run target/cairo1-run/zkstark_signature.sierra.json --layout recursive_with_poseidon --args '[42 1 2 3]' --print_output

artifacts:
	cairo1-run target/cairo1-run/zkstark_signature.sierra.json --layout recursive_with_poseidon --args '[42 1 2 3]' --proof_mode --air_public_input target/public_input.json --air_private_input target/private_input.json --trace_file target/trace --memory_file target/memory
